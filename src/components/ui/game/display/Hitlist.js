        ...
        <div className="game-hitlist">
            <div className="hitlist">
                <div className="hitlist-left">
                    { 3 <= hitList.length ? (
                    <Profile user={new Player(hitList[2][0])} mode="hitlist" votes={hitList[2][1].length} onHoverEvent={updateHoveredPlayer} key={`${player.id}-hitlist`}/>
                    ) : null}
                    { 1 <= hitList.length ? (
                    <Profile user={new Player(hitList[0][0])} mode="hitlist" votes={hitList[0][1].length} onHoverEvent={updateHoveredPlayer} key={`${player.id}-hitlist`}/>
                    ) : null}
                </div>
                ...
                <div className="hitlist-right">
                    { 2 <= hitList.length ? (
                    <Profile user={new Player(hitList[1][0])} mode="hitlist" votes={hitList[1][1].length} onHoverEvent={updateHoveredPlayer} key={`${player.id}-hitlist`}/>
                    ) : null}
                    { 4 <= hitList.length ? (
                    <Profile user={new Player(hitList[3][0])} mode="hitlist" votes={hitList[3][1].length} onHoverEvent={updateHoveredPlayer} key={`${player.id}-hitlist`}/>
                    ) : null}
                </div>
            </div>
        </div>
